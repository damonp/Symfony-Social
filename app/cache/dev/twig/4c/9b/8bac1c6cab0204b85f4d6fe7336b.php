...
class __TwigTemplate_4c9b8bac1c6cab0204b85f4d6fe7336b extends Twig_Template
{
    ...
    ";
        ...
        ";
            ...
            if (($this->getAttribute($this->getContext($context, 'admin'), "hasroute", array("edit", ), "method", false) && $this->getAttribute($this->getContext($context, 'admin'), "isGranted", array("EDIT", ), "method", false))) {
                // line 16
                echo "            <a href=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'admin'), "generateObjectUrl", array("edit", $this->getContext($context, 'object'), ), "method", false), "html");
                echo "\">
        ";
